...
## 🧮 Excel Pre-Analysis
Before building the dashboard, data was cleaned and analyzed in Excel.  
Additional calculations included:
- Daily and product-level variance between target and actual sales.
- Achievement percentage for each day and product.
- Branch performance summaries.  

These were highlighted in yellow for clarity.

---

## 🛠 Tools Used
- Microsoft Excel – Data cleaning and pre-analysis  
- Microsoft Power BI – Data modeling and visualization  

---

## 📎 Files in This Repository
- `Sales-Data_Master.xlsx` – Raw and cleaned data  
- `PowerBI_Report.pbix` – Power BI dashboard file  
- `README.md` – Project documentation  
- `Screenshots/` – Containing dashboard and data model images  

---

## 📧 Author
**Sydul Arefin**  
Power BI | Data Analytics | Excel  
